...
#__PROTRACTOR_CONFIG_PATH="${__ROOT_PATH}src/**/Tests/E2E/protractor.config.js"

# New protractor.config.js location.
__PROTRACTOR_CONFIG_PATH=$(find ${__ROOT_PATH}src/**/Tests/E2E/protractor.config.js)
echo "${__PROTRACTOR_CONFIG_PATH}"
